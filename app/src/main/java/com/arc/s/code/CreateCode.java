...
public class CreateCode {
     ...
     * 点击后执行的函数
     */
    public void attemptLogin(EditText editText1, ImageView imageView, Context applicationContext) {

        //按钮
        //ImageView imageView = findViewById(R.id.aaaPic);
        //输入框
        // EditText editText1 = (EditText) findViewById(R.id.editText1);
        String sms = editText1.getText().toString();
        //获取短信中的验证码
        //sms = getNumber(sms);
        Bitmap bitmap = createQRImage(sms, 400, 400);
        imageView.setImageBitmap(bitmap);
        imageView.setTooltipText("");
        //提示被点击了
        Toast toast = Toast.makeText(applicationContext, "截取到的验证码是" + sms, Toast.LENGTH_LONG);
        toast.show();
    }
